...
import Reserve from "@/components/forms/formReservation/Reserve";
import styles from "./reservations.module.css";
import { Reservation } from "@/interface";
import { deleteReservation, getReservations } from "@/api/api";
...
const Reservations: React.FC = () => {
  ...
  const handleDelete = async (reservationId: string, relationId: string) => {
    try {
      ...
      const result = await deleteReservation(reservationId, relationId, token);
